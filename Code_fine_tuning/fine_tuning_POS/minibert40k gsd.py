# Generated from: minibert40k gsd.ipynb
# Converted at: 2026-01-09T23:25:09.145Z
...
# 
# Chargement du DatasetDict avec les trois splits standards
dataset = DatasetDict({
    "train": load_conllu_to_hf("fr_gsd-ud-train.conllu"),
    "validation": load_conllu_to_hf("fr_gsd-ud-dev.conllu"),
    "test": load_conllu_to_hf("fr_gsd-ud-test.conllu")  
})

print(f"✅ Fichiers GSD chargés : {dataset.keys()}")

print(" Fichiers GSD locaux chargés avec succès !")
...
training_args = TrainingArguments(
    output_dir="./results_camembert_pos",
    ...
    metric_for_best_model="accuracy", # Basé sur l'accuracy
)
